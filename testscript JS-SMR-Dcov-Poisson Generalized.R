...
source("Nimble Model JS-SMR-Dcov-Poisson Generalized.R")
source("Nimble Functions JS-SMR-Dcov-Poisson Generalized.R") #contains custom distributions and updates
...
nimbuild <- init.SMR.Dcov.Open.Generalized(data,inits,M=M,obsmod="poisson")

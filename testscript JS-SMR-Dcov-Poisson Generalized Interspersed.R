...
source("Nimble Model JS-SMR-Dcov-Poisson Generalized Interspersed.R")
source("Nimble Functions JS-SMR-Dcov-Poisson Generalized Interspersed.R") #contains custom distributions and updates
...
nimbuild <- init.SMR.Dcov.Open.Generalized.Interspersed(data,inits,M=M,obsmod="poisson")

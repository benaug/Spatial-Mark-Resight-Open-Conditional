...
source("Nimble Model JS-SMR-Dcov-mobileAC-Negbin Generalized.R")
source("Nimble Functions JS-SMR-Dcov-mobileAC-Negbin Generalized.R") #contains custom distributions and updates
...
nimbuild <- init.SMR.Dcov.mobileAC.Open.Generalized(data,inits,M=M,obsmod="negbin")
...
constants <- list(n.primary=n.primary,M=M,J.mark=J.mark,J.sight=J.sight,
                  ...
                  n.sight.g=n.sight.g,n.samples=nimbuild$n.samples,
...
Niminits <- list(N=nimbuild$N,N.survive=nimbuild$N.survive,N.recruit=nimbuild$N.recruit,
                 ...
                 theta.d.fixed=inits$theta.d[1],sigma.fixed=inits$sigma[1],
...
parameters <- c('N','gamma','N.recruit','N.survive','N.super','lambda.y1',
                'phi.fixed','p0','lam0','theta.d.fixed','sigma.fixed','sigma.move',
                'rsf.beta','theta.marked','theta.unmarked','D0','D.beta1','n.cap')
nt <- 1 #thinning rate
parameters2 <- "ID"
nt2 <- 5
...
config.nodes <- c('phi.fixed','gamma','p0','lam0','theta.d.fixed','sigma.fixed','sigma.move','rsf.beta',
